...
Tired of Microsoft shenanigans and Windows eating all of your RAM? In this guide you’ll see how to setup a full disk encryption with Artix Linux with the init system called dinit on your machine as well as rice the distro to be **secure** and **usefull**. It will contain detailed informations to guide you through the install process and more. The next few articles will continue to help you to install a graphical interface and more!
