...
description: "The first part of my guide to run Linux as your daily driver"
author: "Léo Mercier"
...
```sh
basestrap -i /mnt base base-devel dinit
```
...
```sh
basestrap -i /mnt linux-firmware linux-hardened linux-hardened-headers mkinitcpio seatd seatd-dinit dhcpcd dhcpcd-dinit
```
